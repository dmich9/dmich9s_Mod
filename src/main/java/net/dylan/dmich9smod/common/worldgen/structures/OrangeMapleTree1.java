...
public class OrangeMapleTree1 extends StructureFeature<JigsawConfiguration> {

    public OrangeMapleTree1() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, OrangeMapleTree1::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!OrangeMapleTree1.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            LogManager.getLogger().log(Level.DEBUG, "Orange Maple Tree 1 at {}", blockpos);
        }
