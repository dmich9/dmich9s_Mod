...
public class AnguishTree2 extends StructureFeature<JigsawConfiguration> {

    public AnguishTree2() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, AnguishTree2::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!AnguishTree2.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            LogManager.getLogger().log(Level.DEBUG, "Anguish Tree 2 at {}", blockpos);
        }
