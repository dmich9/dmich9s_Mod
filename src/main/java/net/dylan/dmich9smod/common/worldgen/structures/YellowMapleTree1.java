...
public class YellowMapleTree1 extends StructureFeature<JigsawConfiguration> {

    public YellowMapleTree1() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, YellowMapleTree1::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!YellowMapleTree1.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            LogManager.getLogger().log(Level.DEBUG, "Yellow Maple Tree 1 at {}", blockpos);
        }
