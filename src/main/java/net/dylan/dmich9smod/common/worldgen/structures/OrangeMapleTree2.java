...
public class OrangeMapleTree2 extends StructureFeature<JigsawConfiguration> {

    public OrangeMapleTree2() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, OrangeMapleTree2::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!OrangeMapleTree2.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            LogManager.getLogger().log(Level.DEBUG, "Orange Maple Tree 2 at {}", blockpos);
        }
