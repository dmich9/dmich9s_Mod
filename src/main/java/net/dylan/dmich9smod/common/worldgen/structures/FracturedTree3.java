...
public class FracturedTree3 extends StructureFeature<JigsawConfiguration> {

    public FracturedTree3() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, FracturedTree3::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!FracturedTree3.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            LogManager.getLogger().log(Level.DEBUG, "Fractured Tree 3 at {}", blockpos);
        }
