...
public class FracturedTree2 extends StructureFeature<JigsawConfiguration> {

    public FracturedTree2() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, FracturedTree2::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!FracturedTree2.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            LogManager.getLogger().log(Level.DEBUG, "Fractured Tree 2 at {}", blockpos);
        }
