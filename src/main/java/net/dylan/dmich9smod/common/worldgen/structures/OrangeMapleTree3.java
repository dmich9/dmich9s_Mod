...
public class OrangeMapleTree3 extends StructureFeature<JigsawConfiguration> {

    public OrangeMapleTree3() {
        // Create the pieces layout of the structure and give it to the game
        super(JigsawConfiguration.CODEC, OrangeMapleTree3::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
    @Override
    ...
    public static Optional<PieceGenerator<JigsawConfiguration>> createPiecesGenerator(PieceGeneratorSupplier.Context<JigsawConfiguration> context) {
        if (!OrangeMapleTree3.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            LogManager.getLogger().log(Level.DEBUG, "Orange Maple Tree 3 at {}", blockpos);
        }
